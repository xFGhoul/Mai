...
from typing import Final, Tuple, final, Union
...
class Emoji:
    ...
    JISHAKU: Final[str] = "<:jishaku_logo1:1025809613934841936>"


@final
class MAI:
    ROOT_DIR: Final[str] = os.path.abspath(os.curdir)
    ...
    DEVELOPER_IMAGE: Final[
        str
    ] = "https://cdn.discordapp.com/attachments/890304279737405510/896925340931334174/bd_wallpaper_2.gif"
...
@final
class Logging:
    MAI_LOGS_PATH: Final[Union[str, Path]] = "logs/mai/[Mai]-{time:D-M-YY}.log"